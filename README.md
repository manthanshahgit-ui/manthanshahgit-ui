...
- Library Management System (EJS-based web app for managing books and issues)  
- Club Project & College Workshop Projects (Frontend + JavaScript-based applications)

👯 I’m looking to collaborate on  
- Web development projects (HTML, CSS, JavaScript, Node.js)  
- Open-source beginner-friendly projects  
- UI/UX improvement projects for student tools  

🤝 I’m looking for help with  
- Backend optimization for full-stack projects  
- Improving project structure and scalability  
- Deploying full-stack applications (Render / Vercel / Netlify)  

🌱 I’m currently learning  
- Full-stack web development (MERN stack basics)  
- API development and integration  
- Data handling & visualization using Python (Jupyter Notebook projects)  

💬 Ask me about  
- HTML, CSS, JavaScript projects  
- EJS-based dynamic web apps  
- College-level mini projects & case studies  
- Beginner-friendly Git & GitHub setup  

⚡ Fun fact  
I enjoy turning simple college assignments into full working web applications 🚀  
